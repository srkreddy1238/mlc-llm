...
python3 -m mlc_llm compile ./dist/Llama-2-7b-chat-hf-q4f16_0-MLC/mlc-chat-config.json --device windows:adreno_x86 -o ./dist/libs/Llama-2-7b-chat-hf-q4f16_0-windows.dll
